...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        self.params['W2'] = np.random.normal(loc=0.0, scale=weight_scale, size=(num_filters * int(input_dim[1] / 2) * int(input_dim[2] / 2), hidden_dim))
    ...
    def loss(self, X, y=None):
        ...
        dl, grads['W3'], grads['b3'] = affine_backward(dl, affine2_cache)
        grads['W3'] += (self.reg * self.params['W3'])
        dl = relu_backward(dl, relu2_cache)
        dl, grads['W2'], grads['b2'] = affine_backward(dl, affine1_cache)
        grads['W2'] += (self.reg * self.params['W2'])
        dl = max_pool_backward_fast(dl, pool_cache)
        dl = relu_backward(dl, relu1_cache)
        dl, grads['W1'], grads['b1'] = conv_backward_fast(dl, conv_cache)
